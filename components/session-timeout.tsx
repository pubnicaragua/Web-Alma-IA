...
const INACTIVITY_TIMEOUT = 120; // 30 minutes in seconds
// Tiempo de advertencia antes del logout - 2 minutos
const WARNING_TIME = 30; // 2 minutes in seconds
      ...
      <Dialog open={showConfirmation} onOpenChange={setShowConfirmation}>
        <DialogContent className="sm:max-w-[425px]">
          ...
          <div className="mt-4 text-center">
            <div className="text-sm text-muted-foreground mb-2">
              ...
              <span className="font-semibold">
                {formatTime(confirmationTimeLeft)}
              </span>
            </div>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleExtendSession}>Continuar</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </>
