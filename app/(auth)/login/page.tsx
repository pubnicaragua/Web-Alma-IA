...
export default function LoginPage() {  
  ...
  const [isCaptchaChecked, setIsCaptchaChecked] = useState(false) // Nuevo estado para el checkbox de captcha  
      ...
      <form onSubmit={handleSubmit} className="space-y-4">  
        ...
        <div className="border rounded-md p-3 flex items-center space-x-3">  
          <Checkbox   
            ...
            onCheckedChange={(checked) => setIsCaptchaChecked(checked as boolean)} // Actualizar el estado  
          />  
