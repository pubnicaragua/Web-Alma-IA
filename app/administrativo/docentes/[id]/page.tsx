  ...
  const confirmStatusChange = async () => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description:
          "Ocurrió un error al intentar eliminar el docente. Por favor, inténtalo de nuevo.",
        variant: "destructive",
      });
    } finally {
      ...
      <AppLayout>
        <div className="container mx-auto px-6 py-8">
          ...
          >
            ...
            <div className="mt-4">
              <Button
                onClick={() => router.push("/administrativo/docentes")}
                variant="outline"
              >
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              {teacher?.estado === "activo" ? "desactivar" : "activar"} a este
              docente?
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
              ...
              <div className="flex flex-col items-center md:items-start">
                <h1 className="text-3xl font-bold text-gray-800">
                  {teacher.personas.nombres}
                </h1>
                <p className="text-xl text-gray-600 mb-2">
                  {teacher.personas.apellidos}
                </p>
            ...
            <div className="space-y-4">
              <div className="flex flex-col">
                ...
                <span className="text-gray-800 font-medium">
                  {teacher.personas.nombres + " " + teacher.personas.apellidos}
                </span>
              </div>
              <div className="flex flex-col">
                <span className="text-sm text-gray-500 mb-1">
                ...
                <span className="text-gray-800 font-medium">
                  {teacher.personas.fecha_nacimiento || "No disponible"}
                </span>
              </div>
              <div className="flex flex-col">
              ...
              <div className="space-y-4">
                <div className="flex items-center p-3 bg-gray-50 rounded-lg border border-gray-100">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-gray-800 font-medium">
                      {teacher?.especialidad || "No disponible"}
                    </span>
                  </div>
                </div>
                  ...
                  <div
                    className={`h-5 w-5 rounded-full ${
                      teacher?.estado === "activo"
                        ? "bg-green-500"
                        : "bg-amber-500"
                    } text-white flex items-center justify-center text-xs mr-3`}
                  >
